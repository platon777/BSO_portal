...
export class MySubClassedDexie extends Dexie {
  ...
  constructor() {
    ...
    this.version(3).stores({
      ...
      transactions_epargne: 'id_transaction_epargne, id_compte_epargne, no_compte, type_transaction, montant, solde_declare, virement_from, type_frais_livret, solde_avant_transaction, date_transaction, solde_apres_transactions, created_at, created_by, updated_at',
