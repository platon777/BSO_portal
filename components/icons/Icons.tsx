...
export const PiggyBankIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 5.5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1Z"/><path d="M14 10.5h1"/><path d="M9.5 12.5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1Z"/><path d="M2 12.83V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.17"/><path d="M20 12.83A4.5 4.5 0 0 0 15.17 8h-6.34A4.5 4.5 0 0 0 4.17 12.5H4"/></svg>
);
...
export const DownloadCloudIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>
);
